...
from overcooked_ai.src.overcooked_ai_py.mdp.overcooked_env import OvercookedEnv as OriginalEnv
...
class OverCookedEnv():
    ...
    def __init__(self,
        ...
        self.n = len(self.overcooked.lossless_state_encoding_mdp(self.overcooked.state))
