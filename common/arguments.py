...
def get_args():
    ...
    # Environment
    parser.add_argument("--scenario-name", type=str, default="asymmetric_advantages", help="name of the scenario script")
    parser.add_argument("--max-episode-len", type=int, default=500, help="maximum episode length")
    parser.add_argument("--time-steps", type=int, default=500000, help="number of time steps")
